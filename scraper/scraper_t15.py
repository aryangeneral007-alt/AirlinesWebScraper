...
# ── project config (inline, T+15 only — single-window 4-route version.
#    Mirrors the proven scraper_t7.py structure; date falls ~half a month
#    ahead, mostly within the current month or the next) ──────────────────
import random
...
# T+15 only — single-window version, all 4 routes.
BOOKING_WINDOWS = [7]
DAYS_AHEAD = 7    # T+15 primary window
CABIN_CLASS = "Economy"
