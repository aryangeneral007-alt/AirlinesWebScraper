...
# ── project config (inline, T+30 only — single-window 4-route version.
#    Mirrors the proven scraper_t7.py structure; date falls 1 month ahead
...
# T+30 only — single-window version, all 4 routes.
BOOKING_WINDOWS = [30]
DAYS_AHEAD = 30                             # T+30 primary window
CABIN_CLASS = "Economy"
